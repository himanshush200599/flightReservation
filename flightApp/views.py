...
def save_reservation(request):
    ...
    passenger.firstName = request.data.get('firstName')
    passenger.lastName = request.data.get('lastName')
    passenger.middleName = request.data.get('middleName')
    passenger.email = request.data.get('email')
    passenger.phone = request.data.get('phone')
